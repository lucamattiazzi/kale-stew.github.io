const posts = {
  ...
  'Friday April 10th 2020': {
    ...
    celebrating: 'On my island in Animal Crossing.',
    watching:
      "30 Rock since I found out it's available to stream on Amazon Prime.",
    listeningTo:
      'A playlist I have on Soundcloud titled Headspace while I work from home, all day every day.',
    learning:
    ...
    workingOn:
      "The above mentioned rewrite, now that we've shipped Spectacle v6. 🎉",
  },
  'Sunday January 5th 2020': {
    location: 'At home in Denver, Colorado.',
    travel:
      'Next month, to the 4th Annual Formidagathering (4midagathering, if you will) in Seattle, Washington.',
    reading:
      'One Hundred Names for Love: A Memoir by Diane Ackerman. A little lighter than my last, Edible Woman by Margaret Atwood.',
